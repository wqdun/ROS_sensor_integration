...
//=============================================================================
//=============================================================================
// $Id: SaveImageFileChooserDialog.h,v 1.3 2009-08-26 17:37:19 soowei Exp $
//=============================================================================
...
class SaveImageFileChooserDialog
{
	public:
		...
		SaveImageFileChooserDialog( Gtk::Window* pWindow, std::string defaultFileName );
		 ...
		 */
		void Run( std::string& filename, FlyCapture2::ImageFileFormat& format );
