...
#ifndef VINS_PC_INTEGRATION_BASE2_H
#define VINS_PC_INTEGRATION_BASE2_H
...
class IntegrationBase2
{
public:

    IntegrationBase2() = delete;
    IntegrationBase2(const Eigen::Vector3d &_acc_0, const Eigen::Vector3d &_gyr_0,const double &_encoder_v0,
                             ...
                             Eigen::Vector3d &result_linearized_ba, Eigen::Vector3d &result_linearized_bg, bool update_jacobian)
    {
        ...
        if(update_jacobian)
        {
            ...
            V2.block<3, 3>(0, 9) =  V.block<3, 3>(0, 3);
            ...
            V2.block<3, 3>(6, 9) =  V.block<3, 3>(6, 3);
...
#endif //VINS_PC_INTEGRATION_BASE2_H
