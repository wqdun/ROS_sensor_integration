/******************************************************************************
// Author     : https://github.com/zxteloiv
// Date       : *
// Description: A python2 binding to coordtrans, which is written in C++ and
                provides coordinate conversion between bd09ll, gcj02 and wgs84
// Website    : https://github.com/zxteloiv/pycoordtrans
// Usage      : coordtrans(from to lng lat), visit website above for detail
******************************************************************************/
