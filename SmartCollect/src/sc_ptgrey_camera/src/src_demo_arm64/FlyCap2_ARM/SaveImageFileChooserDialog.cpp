...
//=============================================================================
//=============================================================================
// $Id: SaveImageFileChooserDialog.cpp,v 1.7 2009-08-26 17:37:19 soowei Exp $
//=============================================================================
...
SaveImageFileChooserDialog::SaveImageFileChooserDialog( Gtk::Window* pWindow, std::string defaultFileName )
{
...
void SaveImageFileChooserDialog::Run( std::string& filename, FlyCapture2::ImageFileFormat& format )
{
