...
<body>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="profile">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                       ...
                       <div class="progress progress-striped active">
                          <div class="progress-bar progress-bar-success" role="progressbar"
                              aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
                              style="width: 0%;" id="slam_bar">
                            <span class="sr-only" id="slam_content">0%</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-actions">
                      ...
                      <button class="btn btn-inverse" id="doSlam" data-toggle="modal"
                          data-target="#optModal">SLAM建图
                      </button>
  ...
  if(navigator.userAgent.toLowerCase().indexOf('mobile') > -1) {
    ...
    var slamListener_ = new ROSLIB.Topic({
      ros: ros_,
      name: '/sourceLidarProcessedValue',
      messageType: 'std_msgs/Float64'
    });
    slamListener_.subscribe(
        function(message) {
          var slamPercent = message.data * 100;
          slamPercent = slamPercent.toFixed(2);
          console.log("slamPercent: " + slamPercent);
          $("#slam_bar").css("width", slamPercent + "%");
          $("#slam_content").html(slamPercent + "%");
        }
      );
    ...
    $('#doSlam').click(function () {
        $("#optname").html('SLAM建图: ' + $("#dirname").selectpicker('val'));
        $("#optid").text("8");
        // $('.selectpicker option:selected').remove();
        // $('.selectpicker').selectpicker('refresh');
    })
