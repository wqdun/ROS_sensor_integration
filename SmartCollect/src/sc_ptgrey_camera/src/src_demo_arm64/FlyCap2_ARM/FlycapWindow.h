...
//=============================================================================
//=============================================================================
// $Id: FlycapWindow.h,v 1.54 2009-09-08 22:53:20 soowei Exp $
//=============================================================================
...
class FlycapWindow
{
	...
	private:
		/**
		 * Pixel format to use for display to the screen. For GTKmm, the output
		 * format should be either RGB/RGBU. For MFC/Win32 apps, this should be
		 * either BGR or BGRU.
		 */
		static const PixelFormat sk_outputPixelFormat = PIXEL_FORMAT_RGBU;
		 ...
		 */
		static void OnBusArrival( void* pParam, unsigned int serial );
		 ...
		 * @param pParam The parameter passed to the BusManager::RegisterCallback().
		 */
		static void OnBusRemoval( void* pParam, unsigned int serial );
		...
		void ConvertMonoToOutput(Image* pIn, Image* pOut);

		/** If the image is larger than the window size, center the image. */
		void CenterScrolledWindow();
		...
		/** Center the image in the scrolled window. */
		 ...
		 *
		 * @param pWindow Pointer to the parent class.
		 */
		void GrabLoop( FlycapWindow* pWindow );
